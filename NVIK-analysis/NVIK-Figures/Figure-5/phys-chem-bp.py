...
def main():
    input_files = ['nvik.csv', 'fda-enamine.csv', 'antivirals-enamine.csv']
    legend_names = ['NVIs', 'FDA (Enamine)', 'Antivirals (Enamine)']  # Custom legend names
    output_folder = 'plots'
    os.makedirs(output_folder, exist_ok=True)
    
    data_list = []
    for file in input_files:
        data_list.append(process_csv(file))
    
    properties = ['mol_wt', 'hbd', 'hba', 'rotatable_bonds', 'logP', 'tpsa']
    
    for prop in properties:
        plot_property(data_list, legend_names, prop, output_folder)
