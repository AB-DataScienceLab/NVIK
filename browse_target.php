...
if ($fname == 'Target') {
    side_bar();
    $all_rec = file("nipah_target_sort_updated.txt");
    $rec = count($all_rec);
    print "<b><center>Target/Mechanism(Unique) = 44</center></b><br>";
    ...
    print "<thead><tr>
        ...
        <th align='center' bgcolor='#3E6990'><font color='white' size='3'><b>Target/Mechanism</b></font></th>
        <th align='center' bgcolor='#3E6990'><font color='white' size='3'><b>No. of Entries</b></font></th>
        </tr></thead>";
    
  $result = fopen('nipah_target_sort_updated.txt', 'r'); 
$sr_no = 1;
...
while (!feof($result)) {
    ...
    if (!empty($name)) {
        ...
        if ($row = mysql_fetch_assoc($res)) {
            ...
            echo "<td><a href='search-nidb.php?Target=" . urlencode($name) . "&type=Target'><b><i>$name</i></b></a></td>"; // Inhibitor Name column
